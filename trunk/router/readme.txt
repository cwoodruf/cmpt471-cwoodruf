...
fixed sized arrays. Also, an alternate method for accessing interface data was 
...
0 and 255. "eth" can be any 3 characters. These do not affect the current
test network.

The sr_router.c and sr_router.h files tie together packet processing and 
routing. Some "background" processing of arp and buffered packets is also done 
in the while loop in sr_main.c. 
...
The system has been tested on long runs and seemed to be able to stay up 
indefinitely while under moderately heavy load.
